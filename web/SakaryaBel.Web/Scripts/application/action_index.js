var action_index = (function ($) {

    var viewModel = function () {
        this.ActionList = ko.observableArray();
    ...
    function action(ActionId, Name, Description, SubActionCount) {
    ...
    function LoadFromServer(pageNum, url) {
        ...
        actionService.getActionLists(url,
            function (data) {
    ...
    function getAdvancedSearchFilters(skip, top) {
        ...
        return { "actionName": actionName, "userList": ddlUserList, "startDate": startDate, "endDate": endDate, "skip": skip, "top": top };
    }
    ...
    pub.init = function () {
        ...
        jQuery('#actionName').on('input propertychange paste', function () {
            if ($("#actionName").val().length == 0 || $("#actionName").val().length > 4) {
                LoadFromServer(1, getFilters(0, $("#tablePageSize").val(), isAdvanced));
            }
